        ...
        <section className="card__items">
          <div className="card__item">
            ...
            <p>
              ...
              productions. I am currently playing Pillars of Eternity II:
              Deadfire as well as Gwent: The Witcher Card Game. According to
              Steam, my other top played games are Path of Exile, RimWorld and
              Warframe.
            </p>
            <hr />
          </div>
          ...
          <div className="card__item">
            ...
            <p>
              ...
              Radiohead, MF DOOM, Talking Heads, Beach House) I am constantly on
              the search for something new. I enjoy making music playlists to
              catalogue my discoveries (see my lusco-fusco app in the Projects
              section or just click here to jump to that section).
            </p>
            <hr />
          </div>
          <div className="card__item">
            ...
            <p>
              ...
              cooking, drinking and talking about nonsense. When I feel inspired
              I like to write short stories about completely fictional people in
              completely made-up scenarios.
            </p>
          </div>
        </section>
      </article>
