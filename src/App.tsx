    ...
    <div className="app">
      ...
      <div className="about">
        ...
        <p>
          ...
          purus a diam ornare ornare. Integer at dapibus tortor. Morbi et justo
          imperdiet, molestie lectus ut, feugiat mi. Ut fermentum vehicula urna,
          eget pellentesque justo porta a. Etiam laoreet massa nec mollis
          gravida.
        </p>
        <p>
      ...
      <div className="socials">
        <h3>
          ...
          <span className="section-name"> Socials</span>
        </h3>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sed mi
          dolor. Praesent suscipit eget lacus eget venenatis. Mauris in elit
